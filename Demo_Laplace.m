...
% PMoEP
CC_PMoEP = 0.01;            % tune between (0,0.3]
...
for kk = 1:data_num
    ...
    noise = 0.2 * randl(1,m*n-p1);
    X_Noi(Ind(p1+1:end)) = X_Noi(Ind(p1+1:end)) + noise;  % Add Laplace noise
